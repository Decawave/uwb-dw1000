 ...
 */
void
dw1000_gpio_set_mode(struct _dw1000_dev_instance_t * inst, uint8_t gpioNum, uint8_t mode)
{
    uint32_t reg;
 ...
 */
uint8_t
dw1000_gpio_get_mode(struct _dw1000_dev_instance_t * inst, uint8_t gpioNum)
{
    uint32_t reg;
    reg = (uint32_t) dw1000_read_reg(inst, GPIO_CTRL_ID, GPIO_MODE_OFFSET, sizeof(uint32_t));
    reg &= (0x3UL << (6+gpioNum*2));
 ...
 */
uint8_t
dw1000_gpio_get_direction(struct _dw1000_dev_instance_t * inst, uint8_t gpioNum)
{
    uint8_t res;
    uint32_t reg;
    ...
    reg = dw1000_read_reg(inst, GPIO_CTRL_ID, GPIO_DIR_OFFSET, sizeof(uint32_t));
